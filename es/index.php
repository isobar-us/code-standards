...
$page_description = "Estándares de Código y Prácticas Recomendadas de Desarrollo Front-end de Roundarch Isobar";
...
<body>
	...
	<div id="container">
		...
		<header role="banner">
			...
			<ul id="social">
				...
				<li><a href="http://na.isobar.com" id="linkback">Regresar a Isobar US</a></li>
			</ul>
		</header>
	...
	<footer role="contentinfo">
		<p>
			<span class="float_left"><?php print date("Y"); ?> Roundarch Isobar. Todos los derechos reservados.</span>
			<span class="float_right">Todo el contenido esta licenciado bajo <a href="http://creativecommons.org/licenses/by/3.0/" target="_blank">Licencia de Atribución 3.0 de Creative Commons</a></span>
		</p>
	</footer>
