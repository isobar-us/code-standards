...
<!--[if lt IE 7]> <html class="no-js ie ie6" lang="<?php echo LOCALE; ?>"> <![endif]-->
<!--[if IE 7]>    <html class="no-js ie ie7" lang="<?php echo LOCALE; ?>"> <![endif]-->
<!--[if IE 8]>    <html class="no-js ie8" lang="<?php echo LOCALE; ?>"> <![endif]-->
<!--[if IE 9]>    <html class="no-js ie9" lang="<?php echo LOCALE; ?>"> <![endif]-->
